...
const DrawerFilter = ({form, modeOptions, expOptions, skillOptions, handleReset, onSubmit}) => {
    return (
        <Drawer >
            <DrawerTrigger className="rounded-full p-2 border border-text dark:border-text ">
            <MdOutlineFilterList className="w-7 h-7 " />
            </DrawerTrigger>
            <DrawerContent className=" grid place-items-center p-4 mx-auto bg-background dark:bg-background ">
            <form
                onSubmit={form.handleSubmit(onSubmit)}
                className="flex flex-col items-center  gap-5 w-full mt-5 h-full "
            >
                <FormField
                ...
                <Button
                    ...
                    className="  w-1/2 rounded-lg border border-text bg-transparent dark:bg-transparent hover:bg-gray-200 dark:hover:bg-gray-900 text-text dark:text-text "
                >
                    Reset Filters
                </Button>
                <Button
                    className=" w-1/2 bg-secondary dark:bg-secondary text-text dark:text-text hover:bg-accent dark:hover:bg-accent "
                    type="submit"
                >
                    Apply Filters
                </Button>
