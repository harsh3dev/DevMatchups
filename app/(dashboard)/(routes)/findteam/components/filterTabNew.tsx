...
export function FilterTabNew() {
    ...
    return (
        <div className="lg:h-[70vh] flex justify-between items-center flex-col p-5">
            <div className='max-w-4xl w-full mx-auto'>
                <SearchFilter />
            </div>
            <div className="flex flex-row overflow-x-auto lg:flex-col items-center justify-evenly gap-5 w-full mt-5 ">
                ...
                <div className="flex max-w-full px-8 justify-around gap-2 lg:flex-wrap ">
                ...
                <div className="flex w-full border border-dashed border-accent rounded-xl py-4 justify-evenly items-start gap-2 lg:flex-wrap ">
