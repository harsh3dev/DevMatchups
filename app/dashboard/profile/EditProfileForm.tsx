...
import { selectUser, setUser, UserState } from '@/lib/store/features/userSlice/userSlice';
...
const EditProfileForm = () => {
    ...
    return (
        <ScrollArea className=' max-w-full '>
            <form onSubmit={handleSubmit(onSubmit)} className=' w-full h-full flex flex-col justify-between items-start gap-2 '>
                <div className=' w-full flex justify-center items-center gap-2 '>
                    <div className='w-full'>
                        <Label className='text-sm'>Name</Label>
                        <Input {...register('name')} className=' rounded-lg bg-inputGray dark:bg-inputGray border border-secondary focus:outline focus:outline-primary focus:border-primary '/>
                    </div>
                    <div className='w-full'>
                        <Label className='text-sm'>Email</Label>
                        <Input {...register('email')} className='w-full rounded-lg bg-inputGray dark:bg-inputGray border border-secondary focus:outline focus:outline-primary focus:border-primary '/>
                    </div>
                </div>
                ...
                <div className=' w-full flex justify-center items-center gap-2 '>
                    ...
                    <div className=" w-full flex relative items-center">
                        ...
                        <Input {...register('image')} className=' truncate pl-10 w-full rounded-lg bg-inputGray dark:bg-inputGray border border-secondary focus:outline focus:outline-primary focus:border-primary '/>
                    </div>
                </div>
                ...
                <div className='w-full'>
                    ...
                    <Input placeholder='Enter your skills here' {...register('skills')} className=' rounded-lg bg-inputGray dark:bg-inputGray border border-secondary focus:outline focus:outline-primary focus:border-primary '/>
                </div>

                {/* Bio */}
                <div className='w-full'>
                    <Label className='text-sm'>Bio</Label>
                    <Input placeholder='Describe something about yourself...' {...register('bio')} className=' rounded-lg bg-inputGray dark:bg-inputGray border border-secondary focus:outline focus:outline-primary focus:border-primary '/>
                </div>
