	...
	return (
		<div className='w-full h-[90vh] pt-20 relative flex flex-col justify-normal items-center gap-4 ' >
			...
			<div className=' relative w-full h-full flex flex-col px-2 sm:px-0 justify-normal items-center gap-4 overflow-hidden z-[1] '>
				...
				<Image src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=490128&theme=light" alt="DevMatchups - Find&#0032;teams&#0032;and&#0032;skilled&#0032;teammates&#0032;for&#0032;your&#0032;next&#0032;hackathon&#0033; | Product Hunt" style={{width: "250px", height: "54px"}} width="250" height="54" />
				</Link>
