...
const Logos = () => {
    return (
        <motion.div
            ...
            <div className=" max-w-[80%] flex flex-wrap justify-center items-center text-text px-4  mt-10 gap-10 grayscale brightness-0 dark:brightness-[250%] opacity-80 dark:opacity-60 pointer-events-none ">
