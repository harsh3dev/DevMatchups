        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="John" className="focus:border-b-2 border-blue-500 rounded-md bg-sky-50" {...register("name")} required />
            ...
            <div className="space-y-2">
              ...
              <Input id="username" placeholder="Doe" className="focus:border-b-2 border-blue-500 rounded-md bg-sky-50" {...register("username")} required />
          ...
          <div className="space-y-2">
            ...
            <Input id="password" type="password" className="focus:border-b-2 border-blue-500 rounded-md bg-sky-50" {...register("password")} required />
