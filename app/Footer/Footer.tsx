...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-10 md:py-10 lg:py-10">
      <div className="container mx-auto px-4 md:px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-center gap-8 ">
        ...
        <div className="flex flex-wrap justify-normal md:justify-between items-center gap-20 " >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-gray-200">
              <li>
                <Button variant="link" className=" border border-text hover:border-blue-950 dark:hover:bg-blue-950"  >
