...
{/*                     <Link target="_blank" href="/" className=" opacity-60 hover:opacity-100 " ><FaProductHunt /></Link> */}
                    <Link target="_blank" href="https://x.com/" className=" opacity-60 hover:opacity-100 " ><FaXTwitter /></Link>
                    <Link target="_blank" href="https://github.com/" className=" opacity-60 hover:opacity-100 " ><FaGithub /></Link>
                </span>
            </div>
        </footer>
    )
