    ...
    return (
        <footer className="w-full border border-t border-r-0 border-b-0 border-l-0 border-gray-500 text-text pt-[0.1rem] bg-background " >
            <div className="container mx-auto px-4 md:px-6 py-8 flex max-md:flex-wrap justify-between items-start lg:items-start gap-8 ">
                <div className=" relative h-full flex gap-4 md:flex-row flex-col w-full md:w-fit " >
                ...
                <div className="flex flex-wrap w-full md:w-fit px-5 sm:p-0 justify-between gap-5 sm:gap-20 h-full " >
                    ...
                    <div className=" flex flex-col justify-between h-full gap-4 ">
                        ...
                        <ul className=" flex flex-col justify-between items-start gap-2 text-text text-xs md:text-base ">
                            <li>
                                <Link className="flex justify-center items-center gap-2 hover:underline underline-offset-4 rounded-md hover:bg-gray-300/40 dark:hover:bg-gray-900/30 group p-2 " href="mailto:yaahg342@gmail.com" target="_blank">
                                    {/* <MdEmail /> */}
                                    yaahg342@gmail.com
                            ...
                            <li>
                                <Link className="flex justify-center items-center gap-2 hover:underline underline-offset-4 rounded-md hover:bg-gray-300/40 dark:hover:bg-gray-900/30 group p-2 " href="mailto:harshpandey.tech@gmail.com" target="_blank">
                                    {/* <MdEmail /> */}
