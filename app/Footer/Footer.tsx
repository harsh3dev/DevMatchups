...
export default function Footer() {
    return (
        <footer className="w-full border border-t border-r-0 border-b-0 border-l-0 border-gray-500 text-text pt-[0.1rem] bg-background " >
            <div className="container mx-auto px-4 md:px-6 py-8 flex max-md:flex-wrap-reverse justify-between items-start lg:items-start gap-8 ">
                ...
                <div className="flex flex-wrap justify-normal px-5 sm:p-0 md:justify-between gap-5 sm:gap-20 h-full " >
